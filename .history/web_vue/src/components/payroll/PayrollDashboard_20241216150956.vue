  ...
  <div class="payroll-dashboard">
    ...
    <div class="charts" v-if="analytics">
      <div class="chart">
        ...
        <Line
          :data="{
            labels: analytics.time_series.moving_averages.map(d => d.date),
            datasets: [
              {
                label: 'Moving Average',
                data: analytics.time_series.moving_averages.map(d => d.value),
                borderColor: '#36A2EB'
              },
              {
                label: 'Trend',
                data: analytics.time_series.trend.map(d => d.value),
                borderColor: '#FF6384'
              }
            ]
          }"
      ...
      <div class="chart">
        ...
        <Bar
          :data="{
            labels: Object.keys(analytics.seasonal_patterns.seasonal_indices),
            datasets: [{
              label: 'Seasonal Pattern',
              data: Object.values(analytics.seasonal_patterns.seasonal_indices),
