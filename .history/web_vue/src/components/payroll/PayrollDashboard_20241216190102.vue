        ...
        tooltip: {
          callbacks: {
            ...
            afterBody: function(context: any[]) {
              if (context[0].dataset.label === 'Department Total') {
                const deptStats = stats.value?.department_stats?.[context[0].dataIndex];
                return [`Employees: ${deptStats?.employee_count || 0}`];
              }
              return [];
            }
          }
